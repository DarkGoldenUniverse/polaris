    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('0', 'Pending'), ('1', 'In Progress'), ('2', 'Delivered'), ('3', 'Cancelled')], default='0', max_length=5)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('0', 'Pending'), ('1', 'In Progress'), ('2', 'Completed'), ('3', 'Cancelled')], default='0', max_length=5)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ...
                ('order', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='order', to='order.order')),
